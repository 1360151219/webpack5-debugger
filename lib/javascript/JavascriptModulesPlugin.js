...
class JavascriptModulesPlugin {
		...
		compiler.hooks.compilation.tap(
			...
			(compilation, { normalModuleFactory }) => {
				...
				compilation.hooks.renderManifest.tap(PLUGIN_NAME, (result, options) => {
					...
					let render;
					// 这里获取文件名，由于是entryPoint，直接取的outputOptions.fileName
	...
	renderMain(renderContext, hooks, compilation) {
		...
		// 获取webpack 运行时的工具函数
		// Set(13) {size: 13, __webpack_…quire__.e, __webpack_require__, __webpack_…quire__.default, __webpack_…quire__.n, __webpack_…quire__.r, __webpack_…quire__.d, __webpack_…quire__.o, __webpack_…quire__.x, __webpack_…quire__.i, __webpack_…quire__.p, __webpack_…quire__}
